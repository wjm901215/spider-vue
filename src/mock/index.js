...
import * as vehicleTerminal from './modules/vehicleTerminal'
import * as settle from './modules/settle'
import * as reconcilia from './modules/reconcilia'
...
fnCreate(vehicleTerminal,true)
fnCreate(settle,true)
fnCreate(reconcilia,true)
fnCreate(trade,true)
fnCreate(account,true)
